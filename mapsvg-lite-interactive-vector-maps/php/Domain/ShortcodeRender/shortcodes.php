...
if (isset($_REQUEST['mapsvg_shortcode_inline'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended, WordPress.Security.NonceVerification.Missing
	...
	$shortcodeName = get_shortcode_name($shortcode);
	...
	if (!in_array($shortcodeName, $allowedShortcodes)) {
		echo "Add \"$shortcodeName\" to the allowed shortcodes in the MapSVG settings.";
	} else {
 ...
 * @return string|null
 */
function get_shortcode_name($shortcode)
{
